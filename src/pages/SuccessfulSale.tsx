...
export const SuccessfulSale = () => {
  ...
  return (
    <section className="flex px-4 py-5 flex-col h-full  md:px-10 max-md:max-w-2xl max-md:mx-auto">
      ...
      <hr className="absolute bottom-22 text-[#E2E2E2] w-full h-0.5 left-0" />
      <div className="flex w-full justify-between items-center ">
        <Link
          onClick={ResetContext}
          className=" border border-[#E2E2E2] cursor-pointer rounded-full flex gap-2 items-center px-6 py-2.5 group hover:border-[#979797] transition duration-300 active:scale-95 max-[360px]:px-4 max-[360px]:py-1.5"
          to={"/newOffer"}
        >
