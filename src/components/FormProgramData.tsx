...
export const FormProgramData = () => {
  ...
  return (
    <form
      onSubmit={onSubmit}
      className="flex flex-col h-full w-full  self-center gap-6 rounded-lg relative"
    >
      <div className="flex flex-col border-1 border-[#E2E2E2] gap-6 p-4 rounded-lg">
        <div className="flex justify-between items-center ">
          ...
          <img
            ...
            className={`w-full max-w-22 hidden min-[340px]:flex select-none ${
              NewOffer?.firstStep?.program == "Smiles" && "max-w-10!"
            }  ${
              NewOffer?.firstStep?.program == "AirPortugal" && "max-w-30!"
            }`}
        ...
        <hr className="absolute w-full h-[0.0625rem] left-0 top-[3.9rem] text-[#E2E2E2]" />
          ...
          <Controller
            ...
            render={({ field, fieldState }) => (
              <>
                ...
                {fieldState.error && (
                  <span className="text-red-500 text-sm animate-pulse ml-5">
